        ...
        <div class="row">
            ...
            <aside class="col-sm-7">
                <article class="card-body p-4">
                    <h3 class="title mb-3 g-sans-regular">Seminar kewirausahaan</h3>
                    ...
                    <div class="row border no-gutters rounded mb-2">
                        ...
                        <div class="col-8 p-2">
                            <div><span class="badge badge-light mr-2 shadow-none">+ Serifikat</span><span class="badge badge-light shadow-none">+ Snack</spa></div>
                        </div>
                        <div class="col-4 p-2">
